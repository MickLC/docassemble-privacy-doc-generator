...
setup(
    ...
    package_data={
        'docassemble.privacydocgenerator': [
            ...
            'data/questions/includes/hipaa/*.yml',
            'data/questions/includes/state_privacy/*.yml',
            'data/questions/includes/md/*.yml',
            'data/questions/includes/mn/*.yml',
            'data/questions/includes/ct/*.yml',
            'data/questions/includes/ia/*.yml',
            'data/questions/includes/ut/*.yml',
